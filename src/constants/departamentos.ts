// Los 33 departamentos válidos para el filtro `?departamento=` de GET /api/inmuebles/
// y las ciudades/municipios asociados para el filtro `?ciudad=` (coincidencia exacta).
export const CIUDADES_POR_DEPARTAMENTO: Record<string, string[]> = {
  ...
  Antioquia: [
    ...
    'El Carmen de Viboral', 'El Peñol', 'El Retiro', 'El Santuario', 'Entrerríos',
    'Envigado', 'Fredonia', 'Frontino', 'Giraldo', 'Girardota', 'Gómez Plata',
  ...
  Boyacá: [
    ...
    'Chiscas', 'Chita', 'Chitaraque', 'Chivatá', 'Chivor', 'Ciénega', 'Cómbita',
    'Coper', 'Corrales', 'Covarachía', 'Cubará', 'Cucaita', 'Cuítiva', 'Duitama',
    'El Cocuy', 'El Espino', 'Firavitoba', 'Floresta', 'Gachantivá', 'Gámeza',
    'Garagoa', 'Guacamayas', 'Guateque', 'Guayatá', 'Güicán', 'Iza', 'Jenesano',
    'Jericó', 'La Capilla', 'La Uvita', 'La Victoria', 'Labranzagrande',
    'Macanal', 'Maripí', 'Miraflores', 'Mongua', 'Monguí', 'Moniquirá',
    'Motavita', 'Muzo', 'Nobsa', 'Nuevo Colón', 'Oicatá', 'Otanche', 'Pachavita',
    'Páez', 'Paipa', 'Pajarito', 'Panqueba', 'Pauna', 'Paya', 'Paz del Río',
    ...
    'Tunja', 'Tununguá', 'Turmequé', 'Tuta', 'Tutazá', 'Úmbita', 'Ventaquemada',
  ...
  Cesar: [
    ...
    'González', 'La Gloria (Cesar)', 'La Jagua de Ibirico', 'La Paz',
  ...
  Chocó: [
    ...
    'Cantón de San Pablo', 'Cértegui', 'Condoto', 'El Atrato',
    ...
    'Riosucio', 'San José del Palmar', 'Sipí', 'Tadó', 'Unión Panamericana',
    'Unguía',
  ],
  Cundinamarca: [
    'Agua de Dios', 'Albán', 'Anapoima', 'Anolaima', 'Apulo', 'Arbeláez',
    'Beltrán', 'Bituima', 'Bogotá', 'Bojacá', 'Cabrera', 'Cachipay', 'Cajicá',
  ...
  Huila: [
    ...
    'Nátaga', 'Neiva', 'Oporapa', 'Paicol', 'Palermo', 'Palestina', 'Pitalito',
  ...
  Nariño: [
    ...
    'Ricaurte', 'Roberto Payán', 'Samaniego', 'San Bernardo',
    'San José de Albán', 'San Lorenzo', 'San Pablo', 'San Pedro de Cartago',
  ...
  'Norte de Santander': [
    ...
    'Chinácota', 'Chitagá', 'Convención', 'Cúcuta', 'Cucutilla', 'Duranía',
    ...
    'Santiago', 'Santo Domingo de Silos', 'Sardinata', 'Teorama', 'Tibú',
  ...
  Santander: [
    ...
    'Curití', 'El Carmen de Chucurí', 'El Guacamayo', 'El Peñón', 'El Playón',
    'El Socorro', 'Encino', 'Enciso', 'Florián', 'Floridablanca', 'Galán',
...
export const DEPARTAMENTOS: string[] = Object.keys(CIUDADES_POR_DEPARTAMENTO);
